// EnemyEliteSemiAutoGuard.cpp: implementation of the EnemyEliteSemiAutoGuard class.
//
//////////////////////////////////////////////////////////////////////

#include "EnemyEliteSemiAutoGuard.h"

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

AIEnemyEliteSemiAutoGuard::AIEnemyEliteSemiAutoGuard()
{
...
void AIEnemyEliteSemiAutoGuard::Chase()
{
		if(IsStopBlock()){
...
void AIEnemyEliteSemiAutoGuard::Patrol()
{
...
void AIEnemyEliteSemiAutoGuard::Attack()
{
/*	#ifdef _DEBUG
	char temp[512];
	sprintf(temp, "{AI}[EliteRifle] (fire:%f) (fire_time:%f) (time:%f)", fire, fire_time, time);
