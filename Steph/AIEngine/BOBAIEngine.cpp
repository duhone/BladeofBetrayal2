...
#include "EnemyEliteBatonGaurd.h"
#include "EnemyElitePistolGaurd.h"
#include "EnemyEliteSemiAutoGuard.h"

#include "EnemyPrisoner.h"
#include "EnemyPrisonerRock1.h"
...
#include "EnemyGMonster.h"

#include "EnemyGawain.h"

#include "EnemyWolf.h"
#include "EnemyJunkbotFlying.h"
#include "EnemyJunkbotFlying2.h"
#include "EnemyBird.h"
...
#include "EnemyDocWrenchThrower.h"
#include "EnemyDocWrench.h"
#include "EnemyDocRope.h"
...
BOBAIEngine::BOBAIEngine()
{
	...
	time_freq /= 1000000000.0f;
	
	aiobject=0;
	srand( mach_absolute_time() ); 
	sprintf(path, "");
	prev_time = mach_absolute_time();
