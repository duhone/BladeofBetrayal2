// EnemyDockWrench.cpp: implementation of the EnemyDockWrench class.
//
//////////////////////////////////////////////////////////////////////
...
AIEnemyDocWrench::AIEnemyDocWrench()
{
	//time_sword=.60f;
	//swing_sword=0;
	punch_time = .25f;
...
bool AIEnemyDocWrench::IsStopBlock()
{
	int count=0;
...
void AIEnemyDocWrench::UseBrain()
{
