...
//		SetRectangle(rectWorldLoc, 15, 45, -nxOffSet, -15);
//	else if(!S_TIMER)
//	{
//		float x, y;
	...
	//	ipFlags.nCurrAttack = 6;
		...
		case 0:
			{				
				...
				{
					temp = new ProjectileCrashRocket(ipFlags.S_DIRECTION, static_cast<int>(xLoc + nxOffSet + 35), static_cast<int>(yLoc - 2), projectile_list);
				}
				else
				{
					temp = new ProjectileCrashRocket(ipFlags.S_DIRECTION, static_cast<int>(xLoc - nxOffSet - 35), static_cast<int>(yLoc - 2), projectile_list);
		...
		case 1:
			{
				...
				if(ipFlags.S_DIRECTION)
				{
					temp = new ProjectileCrashRocket(ipFlags.S_DIRECTION, static_cast<int>(xLoc + nxOffSet + 35), static_cast<int>(yLoc+9), projectile_list);
		...
		case 2:
			{
				...
				if(ipFlags.S_DIRECTION)
				{
					temp = new ProjectileCrashGrenade(ipFlags.S_DIRECTION, static_cast<int>(xLoc + nxOffSet + 27), static_cast<int>(yLoc-21), projectile_list, true);
		...
		case 3:
			{
				...
				if(ipFlags.S_DIRECTION)
				{
					temp = new ProjectileCrashGrenade(ipFlags.S_DIRECTION, static_cast<int>(xLoc + nxOffSet + 27), static_cast<int>(yLoc-21), projectile_list, false);
		...
		case 4:
			{
				...
				if(ipFlags.S_DIRECTION)	
				{
					temp = new ProjectileCrashBullet(ipFlags.S_DIRECTION, static_cast<int>(xLoc + nxOffSet + 30), static_cast<int>(yLoc - 2));
		...
		case 5:
			{
				...
				{
					Projectile *temp;
					temp = new ProjectileCrashFlak(static_cast<int>(xLoc + nxOffSet + 30), static_cast<int>(yLoc), 45, 45, .5);
					
					(*projectile_list).push_back(temp);
					temp = new ProjectileCrashFlak(static_cast<int>(xLoc + nxOffSet + 30), static_cast<int>(yLoc), 45, 0, .5);
		...
		case 6:
			{
				...
				{
					Projectile *temp;
					temp = new ProjectileCrashFlak(static_cast<int>(xLoc + nxOffSet + 30), static_cast<int>(yLoc+8), 45, 45, .5);
					(*projectile_list).push_back(temp);
					temp = new ProjectileCrashFlak(static_cast<int>(xLoc + nxOffSet + 30), static_cast<int>(yLoc+8), 45, 0, .5);
					(*projectile_list).push_back(temp);
					temp = new ProjectileCrashFlak(static_cast<int>(xLoc + nxOffSet + 30), static_cast<int>(yLoc+8), 45, -45, .5);
					(*projectile_list).push_back(temp);
				}
		...
		case 7:
			{
				...
				if(ipFlags.S_DIRECTION)
				{
					temp = new ProjectileCrashExplosion(static_cast<int>(xLoc + nxOffSet - 18), static_cast<int>(yLoc+15), .4f);
					(*projectile_list).push_back(temp);
				}
				else
				{
					temp = new ProjectileCrashExplosion(static_cast<int>(xLoc + nxOffSet + 9), static_cast<int>(yLoc+15), .4f);
					(*projectile_list).push_back(temp);
				}
