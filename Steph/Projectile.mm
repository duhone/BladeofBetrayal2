...
{
	nAmtDmg = static_cast<int>(nDamage);
...
void Projectile::SetSpriteOffset(int nxOffSet)
{
...
void Projectile::Render()
{
	if(proj_params.timeDelay <= 0)
		if(projectile_spr != 0)
		{
			...
			{
				projectile_spr->SetPositionAbsalute(static_cast<int>(proj_params.xLoc + nxOffSet + xViewLoc ), static_cast<int>(proj_params.yLoc + yViewLoc));
				if(m_vflip)
...
//				pixel_spr->SetPositionAbsalute(static_cast<int>(temp.p1.x + nxOffSet + xViewLoc ), static_cast<int>(temp.p1.y + yViewLoc));
//				pixel_spr->Render();
//				pixel_spr->SetPositionAbsalute(static_cast<int>(temp.p2.x + nxOffSet +xViewLoc ), static_cast<int>(temp.p2.y + yViewLoc));
//				pixel_spr->Render();
			}
			else
			{
