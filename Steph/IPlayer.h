...
#include <list>
using namespace std;
extern CR::Graphics::Sprite* pixel_spr ;
extern CR::Graphics::Sprite* pixel_red_spr ;
extern CR::Graphics::Sprite* pixel_yellow_spr ;
extern CR::Graphics::Sprite* pixel_black_spr ;
extern CR::Graphics::Sprite* pixel_green_spr ;
extern CR::Graphics::Sprite* pixel_blue_spr ;
...
protected:
	...
	float analog_mod_y;
	float analog_mod_x;
	vector<CR::Graphics::Sprite*> hold_sprites;
