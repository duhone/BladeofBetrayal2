...
public:
	...
	int GetWeaponDamage() { return nAmtDmg; }
protected:

	int weapon_type;

	CR::Graphics::Sprite* pixel_spr;
	CR::Graphics::Sprite* pixel_red_spr;
	CR::Graphics::Sprite* pixel_yellow_spr;
	CR::Graphics::Sprite* pixel_black_spr;
	CR::Graphics::Sprite* pixel_green_spr;
