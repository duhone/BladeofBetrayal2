...
//		ipFlags.nCurrAttack = 1;
		...
		case 0:
			...
			{
				temp = new ProjectileJunkbotWalkingBullet(ipFlags.S_DIRECTION, static_cast<int>(xLoc + nxOffSet+20), static_cast<int>(yLoc - 10),projectile_list, 90, 0, .4f, 3);
		...
		case 1:
			...
			if(ipFlags.S_DIRECTION)
			{
				temp = new ProjectileJunkbotWalkingBullet(ipFlags.S_DIRECTION, static_cast<int>(xLoc + nxOffSet+20), static_cast<int>(yLoc - 10),projectile_list, 140, 0, .4f,  .20);
				
				(*projectile_list).push_back(temp);
				
				temp = new ProjectileJunkbotWalkingBullet(ipFlags.S_DIRECTION, static_cast<int>(xLoc + nxOffSet+20), static_cast<int>(yLoc - 10),projectile_list, 130, 80, .45f,  .20);
