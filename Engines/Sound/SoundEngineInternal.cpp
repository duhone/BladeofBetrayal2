...
int SoundEngineInternal::ref_count = 0;

SoundEngineInternal::SoundEngineInternal()
{
...
bool SoundEngineInternal::LoadHSF(char name[])
{
	//FileSTUFF
	char hsf[3];
	int version;
...
void SoundEngineInternal::Release()
{
	ref_count--;
	if(ref_count == 0)  delete this;
}

void SoundEngineInternal::FreeSounds()
{
	Sound *temps;
...
Sound* SoundEngineInternal::GetSound(int arg)
{
	return sound_data[arg];
}

unsigned long SoundEngineInternal::GetBufferSamples()
{
	return num_buffer_samples;
}

void SoundEngineInternal::DoneWithActiveSound(ActiveSound *arg)
{
	available_sounds.push_back(arg);
}

ActiveSound* SoundEngineInternal::GetAvailableSound()
{
